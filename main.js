...
document.addEventListener("DOMContentLoaded", () => {
  ...
  onValue(residencesRef, (snapshot) => {
    ...
    if (data) {
      ...
      let NSFASYesLayer = L.featureGroup(NSFASYes).addTo(map);
      let NSFASNoLayer = L.featureGroup(NSFASNo).addTo(map);
...
legend.onAdd = function (map) {
  ...
  div.innerHTML +=
    '<i class="icon" style="background-image: url(brown.png);background-repeat: no-repeat;"></i><span>More than 1 km</span><br>';
  div.innerHTML +=
